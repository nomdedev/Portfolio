...
> = {
  es: {
    greeting: "Hola, soy",
    title: "Data Scientist | ML Engineer | IA & Automatización",
      ...
      >
        ...
        <div className="flex flex-wrap gap-4 mb-12">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 border border-border text-foreground px-6 py-3 rounded-md font-mono text-sm hover:border-primary hover:text-primary transition-colors duration-300"
          >
